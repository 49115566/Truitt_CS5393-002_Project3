...
Convert strings right after reading to `DSStrings` (see [cstring/STLstringexamples](https://github.com/mhahsler/CS2341/blob/mainChapter1_Programming/vector_string/main_cstring_vs_std_string.cpp)).
